...
import { useScroll, useMotionValueEvent, motion } from 'framer-motion';
import { useState } from 'react';
import { FiPercent, FiMapPin, FiMenu, FiX } from 'react-icons/fi';
import '../styles/newHeader.css';
  ...
  return (
    <>
      ...
      >
        ...
        {/* Navigation + Extra Items */}
        <nav className={`nav-wrapper ${menuOpen ? 'open' : ''}`}>
          <div className="h-sec1-collection-container">
            {navItems.map((item, index) => (
              <motion.div
                key={item.label}
                initial={{ opacity: 0, y: -20 }}
          ...
          <div className="header-extra">
            ...
            <div className="h-sec1-contact-container">
